...
year = 2021
url_home="https://24score.pro/basketball/team/indonesia/prawira_bandung_(m)/{}".format(year)
url_away="https://24score.pro/basketball/team/indonesia/hangtuah_(m)/{}".format(year)
def layout(y):
...
def show_total_match(home_1st,home_2nd,home_3rd,home_4th,away_1st,away_2nd,away_3rd,away_4th,home_1sthalf,home_2ndhalf,\
    ...
    absolutely_max_total=max(max(totalHome),max(totalAway_41))\
                         +max(max(totalAway_83),max(totalHome_61))
...
def show_total_1st_half(home_1st,home_2nd,home_3rd,home_4th,away_1st,away_2nd,away_3rd,away_4th,home_1sthalf,home_2ndhalf,\
    ...
    absolutely_max_total_1st_half=max(max(home_1sthalf),max(away_1sthalf_32))\
                          +max(max(away_1sthalf_74),max(home_1sthalf_51))
    absolutely_min_total_1st_half=min(min(home_1sthalf),min(away_1sthalf_32))\
                          +min(min(away_1sthalf_74),min(home_1sthalf_51))
    print("EXTREMUM: ",absolutely_max_total_1st_half,absolutely_min_total_1st_half)
    print("FOR HOME TEAM 1st/2nd:")
    print(total_1sthalf,total_1sthalf_34)
    print(total_2ndhalf,total_2ndhalf_35)
    print("FOR 2ND TEAM 1st/2nd:")
    print(total_1sthalf_55,total_1sthalf_76)
    print(total_2ndhalf_56,total_2ndhalf_77)


def show_total_2nd_half(home_1st,home_2nd,home_3rd,home_4th,away_1st,away_2nd,away_3rd,away_4th,home_1sthalf,home_2ndhalf,\
           away_1sthalf,away_2ndhalf,total_1sthalf,total_2ndhalf,firstQwtr,secondQwtr,thirdQwtr,fourthQwtr,totalHome,\
           totalAway,totalMatch,\
           home_1st_22,home_2nd_23,home_3rd_24,home_4th_25,away_1st_26,away_2nd_27,away_3rd_28,away_4th_29,home_1sthalf_30,home_2ndhalf_31,\
           away_1sthalf_32,away_2ndhalf_33,total_1sthalf_34,total_2ndhalf_35,firstQwtr_36,secondQwtr_37,thirdQwtr_38,fourthQwtr_39,totalHome_40,\
           ...
           away_1sthalf_74,away_2ndhalf_75,total_1sthalf_76,total_2ndhalf_77,firstQwtr_78,secondQwtr_79,thirdQwtr_80,fourthQwtr_81,totalHome_82,\
           totalAway_83,totalMatch_84):
    print("     FOR HOME TEAM (2ND HALF)   ")
    max_ever_home_2nd_half=max(home_2ndhalf)+max(away_2ndhalf)
    min_ever_home_2nd_half=min(home_2ndhalf)+min(away_2ndhalf)
    print("PROBABLY: ",max_ever_home_2nd_half,min_ever_home_2nd_half)
    print("ACTUALLY: ",max(total_2ndhalf),min(total_2ndhalf))
    print("     FOR AWAY TEAM (2ND HALF)  ")
    max_ever_away_2nd_half=max(away_2ndhalf_75)+max(home_2ndhalf_73)
    min_ever_away_2nd_half=min(away_2ndhalf_75)+min(home_2ndhalf_73)
    print("PROBABLY: ",max_ever_away_2nd_half,min_ever_away_2nd_half)
    print("ACTUALLY: ",max(total_2ndhalf_77),min(total_2ndhalf_77))
    absolutely_max_total_2nd_half=max(max(home_2ndhalf),max(away_2ndhalf_33))\
                           +max(max(away_2ndhalf_75),max(home_2ndhalf_52))
    absolutely_min_total_2nd_half=min(min(home_2ndhalf),min(away_2ndhalf_33))\
                           +min(min(away_2ndhalf_75),min(home_2ndhalf_52))
    print("EXTREMUM: ",absolutely_max_total_2nd_half,absolutely_min_total_2nd_half)

def show_hometeam_total(home_1st,home_2nd,home_3rd,home_4th,away_1st,away_2nd,away_3rd,away_4th,home_1sthalf,home_2ndhalf,\
           away_1sthalf,away_2ndhalf,total_1sthalf,total_2ndhalf,firstQwtr,secondQwtr,thirdQwtr,fourthQwtr,totalHome,\
           totalAway,totalMatch,\
           home_1st_22,home_2nd_23,home_3rd_24,home_4th_25,away_1st_26,away_2nd_27,away_3rd_28,away_4th_29,home_1sthalf_30,home_2ndhalf_31,\
           away_1sthalf_32,away_2ndhalf_33,total_1sthalf_34,total_2ndhalf_35,firstQwtr_36,secondQwtr_37,thirdQwtr_38,fourthQwtr_39,totalHome_40,\
           ...
           away_1sthalf_74,away_2ndhalf_75,total_1sthalf_76,total_2ndhalf_77,firstQwtr_78,secondQwtr_79,thirdQwtr_80,fourthQwtr_81,totalHome_82,\
           totalAway_83,totalMatch_84):
    totalHome.sort(),totalAway_41.sort()
    print("HOME TEAM TOTAL SCORING:")
    print("AT HOME:",*totalHome)
    print("AWAY:   ",*totalAway_41)
    print("HOME TEAM 1ST/2ND:")
    print(home_1sthalf,away_1sthalf_32)
    print(home_2ndhalf,away_2ndhalf_33)
    print("OPPONENT ALLOWS TO SCORING:")
    totalAway_62.sort(),totalHome_82.sort()
    print("AT HOME:",*totalAway_62)
    print("AWAY:",*totalHome_82)

def show_awayteam_total(home_1st,home_2nd,home_3rd,home_4th,away_1st,away_2nd,away_3rd,away_4th,home_1sthalf,home_2ndhalf,\
           away_1sthalf,away_2ndhalf,total_1sthalf,total_2ndhalf,firstQwtr,secondQwtr,thirdQwtr,fourthQwtr,totalHome,\
           totalAway,totalMatch,\
           home_1st_22,home_2nd_23,home_3rd_24,home_4th_25,away_1st_26,away_2nd_27,away_3rd_28,away_4th_29,home_1sthalf_30,home_2ndhalf_31,\
           away_1sthalf_32,away_2ndhalf_33,total_1sthalf_34,total_2ndhalf_35,firstQwtr_36,secondQwtr_37,thirdQwtr_38,fourthQwtr_39,totalHome_40,\
           ...
           away_1sthalf_74,away_2ndhalf_75,total_1sthalf_76,total_2ndhalf_77,firstQwtr_78,secondQwtr_79,thirdQwtr_80,fourthQwtr_81,totalHome_82,\
           totalAway_83,totalMatch_84):
    totalHome_61.sort(),totalAway_83.sort()
    print("AWAY TEAM TOTAL SCORING:")
    print("AT HOME:",*totalHome_61)
    print("AWAY:   ",*totalAway_83)
    print("HOME TEAM 1ST/2ND:")
    print(home_1sthalf_51,away_1sthalf_74)
    print(home_2ndhalf_52,away_2ndhalf_75)
    print("OPPONENT ALLOWS TO SCORING:")
    totalAway.sort(),totalHome_40.sort()
    print("AT HOME:",*totalAway)
    print("AWAY:",*totalHome_40)
