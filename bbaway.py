...
url="https://24score.pro/basketball/team/usa/brooklyn_nets_(m)/"
...
print("1ST IND:",awayScore1)
print()
print("2ND QTR:",total_2nd)
print("2ND IND:",awayScore2)
print()
print("3RD QTR:",total_3rd)
print("3RD IND:",awayScore3)
print()
print("4TH QTR:",total_4th)
print("4TH IND:",awayScore4)
print()
print("TOTAL IND:",totalAway)
print(totalmatch)
