...
year = 2021
url = "https://24score.pro/basketball/team/lithuania/siauliai_(m)/{}".format(year)
...
for score in scores:
    ...
    if home1 < away1 and (home2 >away2 or home3 > away3 or home4 > away4):
        print("Y_______E__________S")
        yes+=1
    if home1
...
for score in scores:
    ...
    totalHome.append(home1+home2+home3+home4),totalAway.append(away1+away2+away3+away4),totalmatch.append( \
        home1 + home2 + home3 + home4 + away1+away2+away3+away4 )
    print(xline)
    if away1 < home1 and (away2 > home2 or away3 > home3 or away4 > home4 ):
        print("Y_____E_______S")
        yes+=1
    count += 1
...
# print("For 4 Qwtrs: ",count,allwin,alllose)
# print("For 3 Qwtrs: ",count,allwin3,alllose3)
print(count,yes)
