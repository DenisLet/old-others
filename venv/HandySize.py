...
def main(url,browser):
    ...
    team1_scored_fh_home, team1_conceded_fh_home = results_first_half(team1_home, loc="home")
    team1_scored_fh_away, team1_conceded_fh_away = results_first_half(team1_away, loc="away")
    team2_scored_fh_home, team2_conceded_fh_home = results_first_half(team2_home, loc="home")
    team2_scored_fh_away, team2_conceded_fh_away = results_first_half(team2_away, loc="away")

    ''' second half results individual'''

    team1_scored_sh_home, team1_conceded_sh_home = results_second_half(team1_home, loc="home")
    ...
    print("1ST HALF   :", sorted(team1_scored_fh_home))
    print("1 HALF BOTH:", sorted(team1_common_fh_home))
    print("2ND HALF   :", sorted(team1_scored_sh_home))
    print("2 HALF BOTH:", sorted(team1_common_sh_home))
    print("FT  IND    :", sorted(team1_ft_home_scored))
    print("FULL TIME  :", sorted(team1_common_ft_home))
    ######################################
    print("+"*30,"SCORED AWAY","+"*30)
    print("1ST HALF   :", sorted(team1_scored_fh_away))
    print("1 HALF BOTH:", sorted(team1_common_fh_away))
    print("2ND HALF   :", sorted(team1_scored_sh_away))
    print("2 HALF BOTH:", sorted(team1_common_sh_away))
    print("FT  IND    :", sorted(team1_ft_away_scored))
    print("FULL TIME  :", sorted(team1_common_ft_away))
    #######################################
    print("-"*30,"CONCEDED HOME","-"*30)
    print("1ST HALF   :", sorted(team1_conceded_fh_home))
    print("2ND HALF   :", sorted(team1_conceded_sh_home))
    print("FT  IND    :", sorted(team1_ft_home_conceded))
    #######################################
    print("-"*30,"CONCEDED AWAY","-"*30)
    print("1ST HALF   :", sorted(team1_conceded_fh_away))
    print("2ND HALF   :", sorted(team1_conceded_sh_away))
    print("FT  IND    :", sorted(team1_ft_away_conceded))
    #######################################
    print()
    print("+"*30,"SCORED HOME","+"*30)
    print(" " * 27, away_team_name)
    print("1ST HALF   :", sorted(team2_scored_fh_home))
    print("1 HALF BOTH:", sorted(team2_common_fh_home))
    print("2ND HALF   :", sorted(team2_scored_sh_home))
    print("2 HALF BOTH:", sorted(team2_common_sh_home))
    print("FT  IND    :", sorted(team2_ft_home_scored))
    print("FULL TIME  :", sorted(team2_common_ft_home))
    ######################################
    print("+"*30,"SCORED AWAY","+"*30)
    print("1ST HALF   :", sorted(team2_scored_fh_away))
    print("1 HALF BOTH:", sorted(team2_common_fh_away))
    print("2ND HALF   :", sorted(team2_scored_sh_away))
    print("2 HALF BOTH:", sorted(team2_common_sh_away))
    print("FT  IND    :", sorted(team2_ft_away_scored))
    print("FULL TIME  :", sorted(team2_common_ft_away))
    #######################################
    print("-"*30,"CONCEDED HOME","-"*30)
    print("1ST HALF   :", sorted(team2_conceded_fh_home))
    print("2ND HALF   :", sorted(team2_conceded_sh_home))
    print("FT  IND    :", sorted(team2_ft_home_conceded))
    #######################################
    print("-"*30,"CONCEDED AWAY","-"*30)
    print("1ST HALF   :", sorted(team2_conceded_fh_away))
    print("2ND HALF   :", sorted(team2_conceded_sh_away))
    print("FT  IND    :", sorted(team2_ft_away_conceded))
