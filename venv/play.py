...
url = "https://www.soccer24.com/match/4hN78TP7/#/match-summary/match-summary"
def teams(link):
    with sync_playwright() as p:
        ...
        # for i in matches:
        #     if "Awrd" in i.inner_text() or "(0)" not in i.inner_text():
        #         continue
        #     if len(i.inner_text()) == 0:
        #         continue
        ...
        if len(match_list) > 0 :
            team_ = list(reduce(lambda i, j: i & j, (set(x) for x in match_list)))
        else:
            team_ = ""
        print(team_)
        count = 0
        for i in match_list:
            ...
            if len(team_) == 1:
                if i[1] in team_:
                    ...
                    home_matches.append(i)
                elif (i[1] == "AET" or i[2] == "AET") and i[3] in team_:
                    home_matches.append(i)
                else:
                ...
                if i[1] in team_ and i[2] in team_:
                    ...
                    home_matches.append(i)
                elif (i[1] == "AET" or i[2] == "AET") and i[3] in team_ and i[4] in team_:
                    home_matches.append(i)
                else:
                    away_matches.append(i)
